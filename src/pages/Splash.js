                            ...
                            <div className="col-lg-12">
                                <div className="inner text-center">
                                    <div className="react-image mb--20">
                                        ...
                                        <img src="https://thebengalstudio.com/icons/icon.png" alt="Doob React" />
                                    </div>
                                    <h1 className="title display-two">
                                        Explore The Future with <br />
                                        <span className="theme-gradient">TBS</span>
